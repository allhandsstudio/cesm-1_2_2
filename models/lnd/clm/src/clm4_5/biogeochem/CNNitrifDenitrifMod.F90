...
! #endif
   ...
   do j = 1, nlevdecomp
      do fc = 1,num_soilc
         ...
         if (o2_decomp_depth_unsat(c,j) .ne. spval .and. conc_o2_unsat(c,j) .ne. spval &
         .and. o2_decomp_depth_unsat(c,j) .gt. 0._r8) then
         ...
         if (anoxia_wtsat) then ! Average saturated fraction values into anaerobic_frac(c,j).
            ...
            if (o2_decomp_depth_sat(c,j) .ne. spval .and. conc_o2_sat(c,j) .ne. spval &
            .and. o2_decomp_depth_sat(c,j) .gt. 0._r8) then
